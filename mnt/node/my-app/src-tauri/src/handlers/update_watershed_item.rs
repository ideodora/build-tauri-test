...
pub struct UpdateWatershedItemRequest {
    pub id: u32,
    pub name: String,
}
...
#[tauri::command]
pub(crate) async fn update_watershed_item(
    _app_handle: tauri::AppHandle,
    sqlite_pool: State<'_, sqlx::SqlitePool>,
    payload: UpdateWatershedItemRequest,
) -> Result<(), String> {
    println!("update_watershed_item, {:#?}", payload);

    database::update_watershed_item(&*sqlite_pool, &payload).await;
